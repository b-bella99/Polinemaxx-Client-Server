          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <div class="col-md-12">
                  <a class="btn text-left bg-maroon text-white" width = "15px" style="margin-bottom: 20px;" href="<?php echo base_url(); ?>admin/film"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a><br>
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <table class="table table-borderless"  style="color: black">
                            <tbody>
                              <tr>
                                <td colspan="3" class="text-center"><img src="<?= base_url().'assets/film/'.$f['gambar']; ?>" width = 300 height = 400></i></td>
                              </tr>
                              <tr>
                                <td>Nama</td>
                                <td>:</td>
                  ...
                  <div class="card border-left-primary shadow h-100 py-2 text-center">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <h3>Trailer <a href="#" style="color: text-primary"><?= $f['nama']; ?></a></h3><br>
