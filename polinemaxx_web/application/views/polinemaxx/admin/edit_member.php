    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-fw fa-users"></i> Member <?= $m['nama']; ?></h1><br>
                        ...
                        <div class="col mr-2">
                          ...
                          <table class="table table-borderless" align="center" style="color: black">
                            <tbody>
                              ...
                              <tr>
                                <td class="text-right">ID Member</td>
                                <td>:</td>
                                <td><input name="id_user" id="id_user" type="number" size="5" value="<?= $m['id_user']; ?>" readonly></td>
                              </tr>
                              <tr>
                                <td class="text-right">Nama</td>
                                <td>:</td>
                                <td><input name="nama" id="nama" type="text" size="30" value="<?= $m['nama']; ?>"></td>
                              </tr>
                              <tr>
                                <td class="text-right">Alamat</td>
                                <td>:</td>
                                <td><textarea name="alamat" id="alamat" cols="30"><?= $m['alamat']; ?></textarea></td>
                              </tr>
                              <tr>
                                <td class="text-right">No Telepon</td>
                                <td>:</td>
                                <td><input name="nohp" id="nohp" type="text" value="<?= $m['nohp']; ?>" size="15" maxlength="12"></td>
                              </tr>
                              <tr>
                                <td class="text-right">Email</td>
                                <td>:</td>
                                <td><input name="email" id="email" type="email" value="<?= $m['email']; ?>" size="30"></td>
                              </tr>
                              <tr>
                                <td class="text-right">Password</td>
                                <td>:</td>
                                <td><input name="password" id="password" type="password" value="<?= $m['password']; ?>" size="30"></td>
                              </tr>
                              <tr>
