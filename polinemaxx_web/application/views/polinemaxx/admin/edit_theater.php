  ...
  <div id="wrapper">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseFour" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="<?php echo base_url(); ?>admin/tambahTheater"><i class="fas fa-fw fa-plus" aria-hidden="true"></i>Tambah Theater</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <?php foreach ($theater as $t):?>
        <!-- Begin Page Content -->
        <div class="container-fluid">
          
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-fw fa-users"></i> Theater <?= $t['nama']; ?></h1><br>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <div class="col-md-7">
                  <a class="btn text-left bg-maroon text-white" width = "15px" style="margin-bottom: 20px;" href="<?php echo base_url(); ?>admin/theater"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a><br>
                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          ...
                          <?php endif ?>
                          <?php echo form_open('admin/updatetheater'); ?>
                          <form action="" method="post">
                          <table class="table table-borderless" align="center" style="color: black">
                            <tbody>
                              <tr>
                                <td colspan="3" class="text-center"><i class="fa fa-industry fa-fw fa-5x"></i></td>
                              </tr>
                              <tr>
                                <td class="text-right">ID Theater</td>
                                <td>:</td>
                                <td><input name="id_user" id="id_user" type="text" size="5" value="<?= $t['id']; ?>" readonly></td>
                              </tr>
                              <tr>
                                <td class="text-right">Nama</td>
                                <td>:</td>
                                <td><input name="nama" id="nama" type="text" size="30" value="<?= $t['nama']; ?>"></td>
                              </tr>
                              <tr>
                                <td class="text-right">Alamat</td>
                                <td>:</td>
                                <td><textarea name="alamat" id="alamat" cols="30"><?= $t['alamat']; ?></textarea></td>
                              </tr>
                              <tr>
                                <td class="text-right">No Telepon</td>
                                <td>:</td>
                                <td><input name="telp" id="telp" type="text" value="<?= $t['telp']; ?>" size="15" maxlength="12"></td>
                              </tr>
                              <tr>
                                <td class="text-right">Bioskop</td>
                                <td>:</td>
                                <td><input name="bioskop" id="bioskop" type="text-white" value="<?= $t['bioskop']; ?>" size="30"></td>
                              </tr>
                              <tr>
                                <td colspan="3"><button type="submit" name="submit" id="submit" class="btn bg-green-dark text-white float-right">Ubah</button></td>
                              </tr>
                            </tbody>
                          </table>
                          </form>
