    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseFour" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="<?php echo base_url(); ?>admin/theater"><i class="fas fa-fw fa-location-arrow" aria-hidden="true"></i> Data Theater</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-fw fa-location-arrow"></i> Theater</h1><br>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">
              <a href="<?php echo base_url(); ?>admin/tambahTheater"><i class="fas fa-fw fa-plus"></i>Tambah Data</a></h6>
            </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0" style="color: black">
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><?= $t->telp; ?></td>
                      <td><?= $t->bioskop; ?></td>
                      <td><a class="btn btn-success" href="<?php echo base_url(); ?>admin/detailTheater/<?= $t->id;?>">Detail</a>
                        <a class="btn btn-warning" href="<?php echo base_url(); ?>admin/editTheater/<?= $t->id;?>"> Edit</a>
                          <a class="btn btn-danger" href="<?php echo base_url(); ?>admin/hapusTheater/<?= $t->id;?>"> Hapus</a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
